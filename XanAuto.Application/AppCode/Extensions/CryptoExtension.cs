...
namespace XanAuto.Application.AppCode.Extenstions
{
    public static partial class Extension
    {
        const string saltKey = "final@@XanAuto!";
        public static string ToMd5(this string value)
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}XanAuto.Application.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}2XanAuto.Application.AppCode.Extensions");
        ...
        {
            byte[] buffer = Encoding.UTF8.GetBytes($"{saltKey}{value}1XanAuto.Application.AppCode.Extensions");
